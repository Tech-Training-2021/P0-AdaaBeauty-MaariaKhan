...
namespace BeautyStore
{
    ...
    class Adaa
    {
        ...
        static void Main(string[] args)
        {
            ...
            usernameArray = File.ReadAllLines(@"C:\Users\Maaria Khan\OneDrive\Documents\BeautyStore\BeautyStore\username.txt");//loads a text file and sets it to an array
            username = new ArrayList(usernameArray);//sets the array to an array list
            passwordArray = File.ReadAllLines(@"C:\Users\Maaria Khan\OneDrive\Documents\BeautyStore\BeautyStore\password.txt");
